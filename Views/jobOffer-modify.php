                    ...
                    <div class="row">                       
                         <div class="col-lg-4">
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                   ...
                                   <select class="form-control" name="idCompany" id="idCompany" value="<?php echo $comp->getName();?>">
                         ...
                         <div class="col-lg-4">
                              <div class="form-group">
                                   ...
                                   <input type="text" name="active" id="active" class="form-control" readonly value="<?php echo $job->getActive();?>">
                              </div>
                         </div>
